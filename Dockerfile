...
RUN unzip -q /var/www/omeka-s-2.0.2.zip -d /var/www/ \
  ...
  &&  rm -rf /var/www/html/ \
  &&  mv /var/www/omeka-s-2.0.2/ /var/www/html/

## Unfortuantely, the following does not work yet!  @TODO Investigate and make it work!
...
# Create one volume for files and config  @TODO: Replace this awful practice!
